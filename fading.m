...
elseif tier == 1
    K_param = 10*rand();   % K parameter is a uniform random variable from 0dB - 10dB
elseif tier == 2
    K_param = 5*rand();   % K parameter is a uniform random variable from 0dB - 5 dB %Rayleigh fading for tier 2 (UHF)
end
