...
SINR_Threshold = -10;
R_min_downlink = 1e6; % minimum rate is 0.5 Mbps
R_min_uplink = 0.5e6; % minimum threshold rate for 
Interference_threshold_downlink = 10^-13 : 10 : 10^-7;
Interference_threshold_dB_downlink = 10*log10(Interference_threshold_downlink);
Interference_threshold_uplink = 10^-13 : 10 : 10^-7;
...
for p = 1 : length(Interference_threshold_dB_downlink)
...
ylabel('Rate(bps)');
title('Rate - Downlink');
plot(ratio, plotable_uhf_macro_average_rate_per_user_downlink, 'g');
hold on
plot(ratio, plotable_mm_small_average_rate_per_user_downlink, 'k');
plot(ratio, plotable_uhf_small_average_rate_per_user_downlink, 'm');
...
ylabel('Rate(bps)');
figure;
plot(ratio, plotable_uhf_macro_average_rate_per_user_uplink, 'g');
hold on
plot(ratio, plotable_mm_small_average_rate_per_user_uplink, 'k');
plot(ratio, plotable_uhf_small_average_rate_per_user_uplink, 'm');
...
figure;
plot(ratio, coupled_users_fraction, ratio, decoupled_users_fraction);
title('Decoupling');
xlabel('l_s / l_u_h_f');
